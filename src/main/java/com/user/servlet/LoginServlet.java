	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if (student != null) {
				...
				session.setAttribute("studentStandard",
						student.getStudentStandard());
				session.setAttribute("studentFee", student.getStudentFee());

				System.out.println("Student Logged In. Student ID: "
			...
			if (parent != null) {
				...
				Student studentInfo = studentDAO
						.getStudentById(parent.getStudentId());

				if (studentInfo != null) {
					session.setAttribute("studentStandard",
							studentInfo.getStudentStandard());
					session.setAttribute("studentFee",
							studentInfo.getStudentFee());
				}

				System.out.println("Parent Logged In. Child Student ID: "
						+ parent.getStudentId());
